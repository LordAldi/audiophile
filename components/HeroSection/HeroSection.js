  ...
  return (
    <section className="relative">
      <div className="image-bg md:hidden">
        <Image src={Hero.heroMobile} layout="responsive" alt="audiophile" />
      </div>
      <div className="image-bg hidden md:block xl:hidden">
        <Image src={Hero.heroTablet} layout="responsive" alt="audiophile" />
      </div>
      <div className="image-bg hidden md:hidden xl:block">
        <Image src={Hero.heroDesktop} layout="responsive" alt="audiophile" />
      </div>
